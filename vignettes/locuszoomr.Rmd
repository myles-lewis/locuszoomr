...
vignette: >
  %\VignetteIndexEntry{locuszoomr guide}
...
```{r, eval=ensdb_eval, message=FALSE, fig.dim=c(8, 7)}
...
```{r, eval=ensdb_eval, fig.dim=c(7, 3.5)}
...
```{r, eval=ensdb_eval, fig.dim=c(7, 2.5)}
...
```{r, eval=ensdb_eval, fig.dim = c(7,7)}
...
```{r eval=ensdb_eval, fig.dim = c(12, 7)}
