...
These gene annotations are outputted via R base graphics system. For users who 
prefer the grid system we recommend looking at Bioconductor packages Gviz or 
ggbio.
