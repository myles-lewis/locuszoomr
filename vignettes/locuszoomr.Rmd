...
whole recombination rate track data file from UCSC genome browser (documented
...
then be loaded into R as a `GRanges` object using `import.bw()`, and then used
directly by `link_recomb()` as follows.
