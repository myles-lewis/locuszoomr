...
between peaks (default 1e07). The function will either find all peaks ordered by
...
## 36 peaks found (0.328 secs)

top_snps <- SLE_gwas$rsid[pks]
head(top_snps)
## [1] "rs141910407" "rs13019891"  "rs4274624"   "rs17849501"  "rs1143679"   "rs35000415"
```
